    ...
    <p align="center">&nbsp;</p>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="0" summary="Links to ESC Standards and Indicators, User Guide, Data Description documents">
        ...
        <tr>
          ...
          <p><a href="DataDictionary2019.pdf" title="Data Dictionary 2019" target="_new">• Data Dictionary</a></p>
               ...
               <p></p>
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99%" height="500px" radius-r="5px" id="iframe1"
                        src="https://dashboard.escworks.net/app/main#/dashboards/5941a075bb4db30000001937?folder=5891ea875dd95c48590000ab&embed=True&l=false&r=true&t=false">
                    </iframe>
               ...
               <p></p> <h2>
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99%" height="500px" id="iframe2"
                        src="https://dashboard.escworks.net/app/main#/dashboards/5941a0b4bb4db30000001973?folder=5891ea875dd95c48590000ab&embed=True&r=true&l=false&t=false">
                    </iframe>
                 <hr width="90%"/>
        <h5>
             Copyright © 2014-
            ...
            <telerik:RadPageView ID="RadPageView4" height="600px" runat="server">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99%" height="500px" id="iframe4"
                        src="https://dashboard.escworks.net/app/main#/dashboards/5941a0febb4db300000019c4?folder=5891ea875dd95c48590000ab&embed=True&l=false&t=false">
                    </iframe>
            ...
            <%--<telerik:RadPageView ID="RadPageView6" Height="600px" runat="server">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="500px" id="iframe6" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/5b16ae7ccf3b99dc21000027?folder=5891ea875dd95c48590000ab&embed=true&r=false">
                    </iframe>
                 <hr width="90%"/>
               <h5>
            Copyright © 2014-
