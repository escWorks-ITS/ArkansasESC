...
public partial class Activities_Default : System.Web.UI.Page
{
    ...
    tx_r3.BusinessObect.Accountability.Assistances myList;
    escWeb.tx_r3.ObjectModel.User user;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            litHours.Text = ((tx_r3.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetHours(Convert.ToDateTime(strDate), Convert.ToDateTime(strDate)).ToString();
            myList = tx_r3.BusinessObect.Accountability.Assistances.GetAssistances(Convert.ToDateTime(strDate), Convert.ToDateTime(strDate), user.Sid);
