...
using Csla;
using tx_r3.BusinessObect.Accountability;
...
public partial class Accountability_Default : System.Web.UI.Page
{
    ...
    private List<tx_r3.BusinessObect.Accountability.Assistance> dailyList;
    private tx_r3.BusinessObect.Accountability.Assistances myList;
    ...
    private escWeb.tx_r3.ObjectModel.Site site;
    private escWeb.tx_r3.ObjectModel.Room room;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        PopulateDropDownList(ddlActivities, "[p.Accountability.DropdownLists.Load]", region4.escWeb.SiteVariables.AccountabilityActivity, "dropdownlsit_activity", 60);
        ...
        PopulateDropDownList(ddlLeaveType, "[p.Accountability.DropdownLists.Load]", 3003, "dropdownlsit_leavetype", 60);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack && !Page.IsCallback)
        {
            ...
            if (date != "" && strObjId != "")
            {
                ...
                dailyList = ((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).GetAssistancesByDateRange(Convert.ToDateTime(date), Convert.ToDateTime(date));
                Session["dailyList"] = dailyList;
                foreach (tx_r3.BusinessObect.Accountability.Assistance a in dailyList)
                {
                    ((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).Index++;
                ...
                myList = (tx_r3.BusinessObect.Accountability.Assistances)Session["myList"];

                litDayHours.Text = myList.GetHours(Convert.ToDateTime(date), Convert.ToDateTime(date)).ToString();
                litThisWeekHours.Text = ((tx_r3.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetHours(Convert.ToDateTime(date).AddDays(7 - (int)Convert.ToDateTime(date).DayOfWeek).AddDays(-7), Convert.ToDateTime(date).AddDays(7 - (int)Convert.ToDateTime(date).DayOfWeek).AddDays(-1)).ToString();
    ...
    protected void calActivity_DayRender(object sender, DayRenderEventArgs e)
    {
        if (Session["myListDisplay"] != null)
        {
            ...
            dailyListDisplay = ((tx_r3.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetAssistancesDisplayByDateRange(e.Day.Date, e.Day.Date);
            if (dailyListDisplay.Count > 0)
            {
                ...
                e.Cell.BackColor = ((tx_r3.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetColor(e.Day.Date);
            }
            else
    ...
    {
        myListDisplay = tx_r3.BusinessObect.Accountability.AssistancesDisplay.GetAssistancesDisplay(new DateTime(e.NewDate.Year, e.NewDate.Month, 1), new DateTime(e.NewDate.Year, e.NewDate.Month, 1).AddMonths(1).AddDays(-1), user.Sid);
        Session["myListDisplay"] = myListDisplay;
        ClearForm();
    ...
    {
        if (ddlActivities.SelectedValue == ConfigurationManager.AppSettings["accountability.activity.leave"])
            litBudgetCode.Visible = false;
        else
            litBudgetCode.Visible = true;

        if (ddlActivities.SelectedValue != ConfigurationManager.AppSettings["accountability.activity.ta"])
        {
            if (ddlActivities.SelectedValue == ConfigurationManager.AppSettings["accountability.activity.leave"])
            ...
            litActivities.Visible = false;
            litClient.Visible = false;
        ...
        else
        {
            ...
            litActivities.Visible = true;
            litClient.Visible = true;
    ...
    protected void BindingData(tx_r3.BusinessObect.Accountability.Assistance assistance)
    {
        ...
        //ddlFocus.SelectedValue = 0; //assistance.Focus_Id.ToString();
        ...
        //Content
        string content_served = string.Empty;
        foreach (tx_r3.BusinessObect.Accountability.Content c in assistance.Contents)
        {
            if (content_served == string.Empty)
            {
                if (assistance.Contents.Count == 1)
                    content_served = c.ContentId.ToString() + ",";
                else
                    content_served = c.ContentId.ToString();
            }
            else
        ...
        content.Value = content_served;
        SetupMultiValueControl(ref lbContent, ref ddlContentList, ref content, content_served);

        //performance
        string performance_served = string.Empty;
        foreach (tx_r3.BusinessObect.Accountability.IncreaseStudentPerformance p in assistance.IncreaseStudentPerformances)
        {
        ...
        foreach (tx_r3.BusinessObect.Accountability.PostSecondaryCredit c in assistance.PostSecondaryCredits)
        {
        ...
        foreach (tx_r3.BusinessObect.Accountability.FinancialIntegrity f in assistance.FinancialIntegritys)
        {
        ...
        foreach (tx_r3.BusinessObect.Accountability.NonFirstStandardFinancialAssistance n in assistance.NonFirstStandardFinancialAssistances)
        {
        ...
        if (DisplayPanelContent(AudienceListBox))
        ...
        cbBillable.Checked = assistance.IsBillable;
    ...
    protected void btnNext_Click(object sender, ImageClickEventArgs e)
    {
        ...
        BindingData((tx_r3.BusinessObect.Accountability.Assistance)((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).MoveNext((List<tx_r3.BusinessObect.Accountability.Assistance>)Session["dailyList"]));

        if (((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).IsLastItem)
        {
            btnNext.Visible = false;
            if (!btnPrev.Visible)
                btnPrev.Visible = true;
    ...
    {
        BindingData(((tx_r3.BusinessObect.Accountability.Assistance)((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).MovePrev((List<tx_r3.BusinessObect.Accountability.Assistance>)Session["dailyList"])));

        if (((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).IsFirstItem)
        {
            btnPrev.Visible = false;
            if (!btnNext.Visible)
                btnNext.Visible = true;
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
        ...
        tx_r3.BusinessObect.Accountability.Assistances assistanceList = (tx_r3.BusinessObect.Accountability.Assistances)Session["myList"];
        if (assistanceList != null)
        {
            assistanceList.Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.New;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        tx_r3.BusinessObect.Accountability.Assistances assistanceList = (tx_r3.BusinessObect.Accountability.Assistances)Session["myList"];
        assistanceList.Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.Delete;
        tx_r3.BusinessObect.Accountability.Assistance a = assistanceList.GetAssistanceByObjId(Convert.ToInt32(txtObjID.Text));
        ...
        if (dailyList.Count <= 1) //Modified by VM 7-20-2012
        {
            ...
            {
                BindingData((tx_r3.BusinessObect.Accountability.Assistance)dailyList[0]);
                pnlDetail.Visible = true;
            }
            else
                pnlDetail.Visible = false;
        ...
        litDayHours.Text = ((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).GetHours(a.Service_Date, a.Service_Date).ToString();
        litThisWeekHours.Text = ((tx_r3.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetHours(Convert.ToDateTime(date).AddDays(7 - (int)Convert.ToDateTime(date).DayOfWeek).AddDays(-7), Convert.ToDateTime(date).AddDays(7 - (int)Convert.ToDateTime(date).DayOfWeek).AddDays(-1)).ToString();
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            if (((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).Action == tx_r3.BusinessObect.Accountability.Assistances.ActionType.New)
            {
                //ClearForm();
                ((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]).Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.None;
                Session["myList"] = ((tx_r3.BusinessObect.Accountability.Assistances)Session["myList"]);
            ...
            else
            {
                ...
                {
                    foreach (tx_r3.BusinessObect.Accountability.Assistance a in (List<tx_r3.BusinessObect.Accountability.Assistance>)Session["dailyList"])
                    {
                        if (a.ObjId == (Convert.ToInt32(strObjId)))
                            BindingData(a);
                    }

                    if (((List<tx_r3.BusinessObect.Accountability.Assistance>)Session["dailyList"]).Count > 1) // Added 7-20-2012
                    {
                        btnNext.Visible = true;
                        btnPrev.Visible = true;
                    }
    ...
    protected void btnCopy_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            tx_r3.BusinessObect.Accountability.Assistances assistanceList = (tx_r3.BusinessObect.Accountability.Assistances)Session["myList"];
            assistanceList.Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.Copy;
            Session["myList"] = assistanceList;
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        site = region4.ObjectModel.ObjectProvider.ReturnSite(Convert.ToInt32(ddlClient.SelectedValue == string.Empty ? "-1" : ddlClient.SelectedValue)) as escWeb.tx_r3.ObjectModel.Site;
        room = region4.ObjectModel.ObjectProvider.ReturnRoom(Convert.ToInt32(ddlSite.SelectedValue == string.Empty ? "-1" : ddlSite.SelectedValue)) as escWeb.tx_r3.ObjectModel.Room;

        if (assistanceList == null) // Added 7-14-2012 If no records
        {
            assistanceList = tx_r3.BusinessObect.Accountability.Assistances.CreateNew();
            assistanceList.Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.New;
        }
        ...
        if (assistanceList.Action == tx_r3.BusinessObect.Accountability.Assistances.ActionType.New || assistanceList.Action == tx_r3.BusinessObect.Accountability.Assistances.ActionType.Copy) //Add a new activity
        {
            //escWorks.BusinessObjects.Assistance a = escWorks.BusinessObjects.Assistance.CreateNew();
            tx_r3.BusinessObect.Accountability.Assistance a = tx_r3.BusinessObect.Accountability.Assistance.CreateNew();
            ...
            a.Focus_Id = 0;// Convert.ToInt32(ddlFocus.SelectedValue);
            a.Team_Id = 0;
            ...
            a.IsBillable = cbBillable.Checked ? true : false;
            ...
            //content
            SetupMultiValueControl(ref lbContent, ref ddlContentList, ref content, content.Value);
            foreach (ListItem itm in lbContent.Items)
            {
                tx_r3.BusinessObect.Accountability.Content ct = tx_r3.BusinessObect.Accountability.Content.CreateNew();
                ct.ContentId = Convert.ToInt32(itm.Value);
                ct.ObjId = a.ObjId;
                ct.ContentName = itm.Text;
                a.Contents.Add(ct);
            }
            ...
            {
                tx_r3.BusinessObect.Accountability.IncreaseStudentPerformance ip = tx_r3.BusinessObect.Accountability.IncreaseStudentPerformance.CreateNew();
            ...
            {
                tx_r3.BusinessObect.Accountability.PostSecondaryCredit pc = tx_r3.BusinessObect.Accountability.PostSecondaryCredit.CreateNew();
            ...
            {
                tx_r3.BusinessObect.Accountability.FinancialIntegrity fi = tx_r3.BusinessObect.Accountability.FinancialIntegrity.CreateNew();
            ...
            if (panelNonFirstStandardFinancialAssistance.Visible)
            {
                ...
                {
                    tx_r3.BusinessObect.Accountability.NonFirstStandardFinancialAssistance fa = tx_r3.BusinessObect.Accountability.NonFirstStandardFinancialAssistance.CreateNew();
            ...
            if (validateFields(a))
            {
                ...
                BindingData((tx_r3.BusinessObect.Accountability.Assistance)dailyList[dailyList.Count - 1]);
                ...
                assistanceList.Action = tx_r3.BusinessObect.Accountability.Assistances.ActionType.Edit;
        ...
        else if (assistanceList.Action != tx_r3.BusinessObect.Accountability.Assistances.ActionType.Delete) // edit
        {
            int currPos;
            if (strObjId == "" && txtObjID.Text == string.Empty)
            {
            ...
            tx_r3.BusinessObect.Accountability.Assistance a = (tx_r3.BusinessObect.Accountability.Assistance)assistanceList.GetAssistanceByObjId(Convert.ToInt32(txtObjID.Text));
    ...
    protected bool validateFields(Assistance a)
    {
        bool result;
        ...
        if (panelLeaveType.Visible && ddlLeaveType.SelectedIndex == 0)
            message.AppendFormat(@"{0}\n\r", "The Leave Type is required.");

        if (panelContent.Visible && lbContent.Items.Count == 0 && ddlActivities.SelectedValue == ConfigurationManager.AppSettings["accountability.activity.ta"])
            message.AppendFormat(@"{0}\n\r", "The improvement/services provided is required.");
    ...
    {
        bool show = false;
        escWeb.tx_r3.ObjectModel.Site site;
        ...
        foreach (ListItem itm in lb.Items)
        {
            ...
            if (myValue[1] != "")
            {
                site = region4.ObjectModel.ObjectProvider.ReturnSite(Convert.ToInt32(myValue[1])) as escWeb.tx_r3.ObjectModel.Site;
    ...
    protected bool DisplayPanelContent(ListBox lb)
    {
        bool show = false;
        escWeb.tx_r3.ObjectModel.Room room;
        escWeb.tx_r3.ObjectModel.Site site;
        ...
        foreach (ListItem itm in lb.Items)
        {
            ...
            if (myValue[2] != "")
            {
                room = region4.ObjectModel.ObjectProvider.ReturnRoom(Convert.ToInt32(myValue[2])) as escWeb.tx_r3.ObjectModel.Room;
                if (room.IsSchoolIdentifier || (room.Site as escWeb.tx_r3.ObjectModel.Site).IsDistrictIdentifier)
                {
                    show = true;
                    break;
                }
