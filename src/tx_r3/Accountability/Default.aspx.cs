...
public partial class Accountability_Default : BasePage
{
    ...
    {
        string script = "<script language='javascript' ID='Message'>window.open('default2.aspx','_blank','top=0, left=50, width=1000, height=800, resizable=yes, scrollbars=1');</script>";
