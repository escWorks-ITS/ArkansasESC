...
<head id="Head1" runat="server">
 ...
 <script type="text/javascript" language="javascript">
     ...
     function AddMultiListTextBox(dropdown, textbox, listbox, hiddenValue, dropdown2, msg, msg2) {
         ...
         var ddControl2 = document.getElementById(dropdown2);
         ...
         var m_Text2 = ddControl2[ddControl2.selectedIndex].text;
         var m_Value2 = ddControl2[ddControl2.selectedIndex].value;
         ...
         var option = new Option(m_Text + ' | ' + tbControl.value + ' | ' + m_Text2, m_Value + ':' + tbControl.value + ':' + m_Value2);
         ...
         if (valueControl.value.length > 0)
             valueControl.value = valueControl.value + ',' + m_Value + ':' + tbControl.value + ':' + m_Value2;
         else
             valueControl.value = m_Value + ':' + tbControl.value + ':' + m_Value2;

         ddControl.selectedIndex = 0;
         ddControl2.selectedIndex = 0;
         tbControl.value = "";
...
<form id="Form1" runat="server">
 ...
 <table id="Table1" style="margin-left: auto; width: 950; margin-right: auto; margin-top: 20px; border-collapse: collapse; border-right: #48789b 1px solid; border-top: #48789b 1px solid; border-left: #48789b 1px solid; border-bottom: #48789b 1px solid;background-color:#ffffff; height:900px" runat="server">
 <tr>
    <td style="background-color:#ffffff; height:60px; border-bottom:solid 1px #667a95">
        <table width="100%" border="0">
            <tr>
                <td><img src='<%= ResolveUrl("~/lib/img/r3_logo_small.jpg")%>' alt="R3 Logo" height="50px"/></td>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
                ...
                <tr> 
                    ...
                    <td align="right">
                        <asp:Literal ID="litStrategies" runat="server"><font color="#FFFFFF">* </font></asp:Literal>
                ...
                <tr>
                    <td align="right">
                        ...
                        <asp:Label ID="ActivitiesLabel"
                            text="Activities:"
                            AssociatedControlID="ddlActivities"
                            runat="server"></asp:Label>
                    </td>
                    <td>
                     <asp:DropDownList ID="ddlActivities" runat="server" Width="200px" OnSelectedIndexChanged="ddlActivities_OnSelectionChange" AutoPostBack="true"></asp:DropDownList>
                    </td>                
                     <td align="right">
                        <asp:Literal ID="litTEC" runat="server"><font color="#FFFFFF">* </font></asp:Literal>
                ...
                <tr>
                    ...
                    <td align="right"><asp:Literal ID="litContactMethod" runat="server"><font color="red">* </font></asp:Literal>
                        <asp:Label ID="ContactMethodLabel"
                            text="Contact Method:"
                            AssociatedControlID="ddlContactMethod"
                            runat="server"></asp:Label></td>
                    <td>
                     <asp:DropDownList ID="ddlContactMethod" runat="server" Width="80px"></asp:DropDownList>
                    </td>     
                    <td align="right"><font color="#FFFFFF">* </font>
                        <asp:Label ID="BillableLabel"
                            text="Billable:"
                            AssociatedControlID="cbBillable"
                            runat="server"></asp:Label></td>
                     <td>
                       ...
                       <asp:Panel ID="panelContent" runat="server" Visible="false">
                        <table cellpadding="0" cellspacing="3" border="0">
                            <tr>
                              ...
                              <asp:Literal ID="litContent" runat="server"><font color="red">* </font></asp:Literal>Improvement/Service Provided:
                                <table border="0" width="410px" cellpadding="3" cellspacing="0">
					                <tr>
						                <td>
						                    Content:<asp:DropDownList ID="ddlContentList" runat="server" Width="300px"></asp:DropDownList>
						                </td>
						                <td>
							                &nbsp;&nbsp;<input type="button" id="ContentAdd" name="ContentAdd" width="60px" value="Add" onclick="AddMultiSelect('ddlContentList', 'lbContent', 'content', 'No Content has been selected.');" /><input type="button" name="btnDeleteNonFirst" id="btnDeleteContent" value="Del." onclick="OnRemoveMulti('lbContent', 'ddlContentList', 'content');"/>
						                </td>
					                </tr>
					                <tr>
						                <td colspan="3">
							                <asp:ListBox ID="lbContent" runat="server" Width="100%"></asp:ListBox>
                    ...
                    <td colspan="6" style="border-top:1 dashed #000000; border-bottom:1 dashed #000000; padding:5px">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              ...
                              <asp:Literal ID="litIncreasedStudentPerformance" runat="server"><font color="#f5f5f5">* </font></asp:Literal>1.1b Increased Student Performance:
                                <table border="0" width="410px" cellpadding="3" cellspacing="0">
					                <tr>
						                <td>
