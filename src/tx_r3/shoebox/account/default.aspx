 ...
 <script type="text/javascript" language="javascript">
    ...
    <asp:Panel runat="server" ID="pFirst">
        <table width="75%" class="mainBody">
            <tr>
                <td colspan="3">
                    <asp:Label ID="PrimaryEmailConfirmLabel"
            ...
            <tr>
                ...
                <td colspan="1" valign="top">
                    <asp:Label ID="StateLabel"
                        text="<strong>State: (Two chars for state abbreviation,i.e TX)</strong>"
            ...
            <tr>
                <td colspan="3" valign="top">
                    <br /><asp:Label ID="SepcialAccomsLabel"
                    ...
                    <table border="0" cellpadding="3" cellspacing="0">
					                ...
					                <tr>
						                <td colspan="2">
                                            ...
                                            <input type="hidden" id="specialneed" runat="server" /><asp:Label ID="SelectedNeedsLabel"
