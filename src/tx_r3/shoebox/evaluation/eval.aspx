		...
		<div align="center">
			...
			<form id="aspnetForm" method="post" runat="server">
				<table cellspacing="0" cellpadding="0" align="center" border="0" style="WIDTH:550px;BORDER-COLLAPSE:collapse;HEIGHT:250px">
						...
						<td class="LayoutContent">
							<table cellpadding="0" cellspacing="5" width="100%" height="100%">
								<tbody>
									...
									<tr>
										<td class="LayoutRule" height="1" colspan="3"><img src="/global/img/trans.gif" border="0" width="1" height="1" alt="Transparent Gif"></td>
									</tr>
					...
					<tr height="1">
						<td class="LayoutRule" colspan="3"><img src="/global/img/trans.gif" border="0" width="1" height="1" alt="Transparent Gif"></td>
					</tr>
					<tr>
						<td bgcolor="#ffffff" colspan="3">&nbsp;<img src="/global/img/ico/32/secure.gif" width="32" height="32" alt="" border="0" align="absMiddle">&nbsp;
