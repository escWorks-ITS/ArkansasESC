...
namespace tx_r3.BusinessObect.Accountability
{
    ...
    public class Assistance : BusinessBase<Assistance>
    {
        ...
        private static PropertyInfo<bool> IsBillabletProperty = RegisterProperty<bool>(new PropertyInfo<bool>("isBillabale"));
        public bool IsBillable
        {
            get { return GetProperty(IsBillabletProperty); }
            set { SetProperty(IsBillabletProperty, value); }
        }
        ...
        private static PropertyInfo<Contents> ContentsProperty =
         RegisterProperty<Contents>(new PropertyInfo<Contents>("Contents"));
        ...
        protected override void AddBusinessRules()
        {
            ...
            //ValidationRules.AddRule(StrategiesRule, Contact_IdProperty);
            ...
            //ValidationRules.AddRule(TEC_PurposeRule, TEC_Purpose_IdProperty);
        }
        ...
        {
            if (((Assistance)target).Contact_Id == 0 && ((Assistance)target).Activity_Id == 1237)
            {
        ...
        private static bool StrategiesRule(object target, Csla.Validation.RuleArgs e)
        {
            if (((Assistance)target).StrategyId == 0 && ((Assistance)target).Activity_Id == 1237)
            {
        ...
        {
            if (((Assistance)target).Budget_Id == 0 && !(((Assistance)target).Activity_Id == 1453))
            {
            ...
            if (!bi.Active && ((Assistance)target).Budget_Id>0)
            {
        ...
        private static bool TEC_PurposeRule(object target, Csla.Validation.RuleArgs e)
        {
            if (((Assistance)target).TEC_Purpose_Id == 0 && ((Assistance)target).Activity_Id == 1237)
            {
        ...
        {
            if (((Assistance)target).LocationAudiences.Count == 0 && ((Assistance)target).Activity_Id == 1237)
            {
        ...
        protected void MapFieldsFromData(SafeDataReader dr)
        {
            using (BypassPropertyChecks)
            {
                ...
                LoadProperty(IsBillabletProperty, dr.GetBoolean("isBillable"));
        ...
        private void Child_Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(ContentsProperty, Contents.GetContents(dr.GetInt32("obj_id")));
        ...
        protected void MapFieldsToParams(SqlCommand cmd)
        {
            ...
            cmd.Parameters.AddWithValue("tec_purpose_id", TEC_Purpose_Id);
