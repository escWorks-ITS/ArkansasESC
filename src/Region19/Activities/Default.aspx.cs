...
public partial class Activities_Default : System.Web.UI.Page
{
    ...
    demo.BusinessObect.Accountability.Assistances myList;
    //escWorks.BusinessObjects.Assistances myList;
    escWeb.tx_r19.ObjectModel.User user;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            litHours.Text = ((demo.BusinessObect.Accountability.AssistancesDisplay)Session["myListDisplay"]).GetHours(Convert.ToDateTime(strDate), Convert.ToDateTime(strDate)).ToString();
            myList = demo.BusinessObect.Accountability.Assistances.GetAssistances(Convert.ToDateTime(strDate), Convert.ToDateTime(strDate), user.Sid);
