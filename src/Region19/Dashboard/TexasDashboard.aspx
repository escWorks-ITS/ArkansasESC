    ...
    <script type="text/javascript">
        function OnClientItemSelected(sender, eventArgs) {
            ...
            if (value == "2016-2017") {
                ...
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57ebfaacdcd554801800036c?folder=57d86f12566352546d0003ca&embed=True&l=false&r=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57ebfd93dcd5548018000528?folder=57d86f12566352546d0003ca&embed=True&r=false&l=false");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/57ebfca6dcd55480180004b1?folder=57d86f12566352546d0003ca&embed=true&r=false&l=false");
            }
            //else if (value == "2014-2015") {
               // top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/5704246c9f0bfe7088000cd3?folder=560c4c8490c0666833000870&embed=true&l=false&r=false");
                //top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/5704249c9f0bfe7088000d0f?folder=560c4c8490c0666833000870&embed=true&l=false&r=false");
                //top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/570424b69f0bfe7088000d5e?folder=560c4c8490c0666833000870&embed=true&r=false");
            //}
      ...
      <h3 align="center">Have a question? Contact us at: <span style="color:white; link color:white; visited color:white; hover color:white; active color:black"><a href="mailto:helpdesk@esc4.net">helpdesk@esc4.net</a></span></h3>
            ...
            <telerik:RadPageView ID="RadPageView2" height="600px" runat="server">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" radius-r="5px" id="iframe1" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57ebfca6dcd55480180004b1?folder=57d86f12566352546d0003ca&embed=true&r=false&l=false">
                    </iframe>
            ...
            <telerik:RadPageView ID="RadPageView3" height="600px" runat="server">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" radius-r="5px" id="iframe2" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57ebfd93dcd5548018000528?folder=57d86f12566352546d0003ca&embed=True&r=false&l=false">
                    </iframe>
            ...
            <telerik:RadPageView ID="RadPageView4" height="600px" runat="server">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" id="iframe4" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/57ebfe77dcd55480180005ce?folder=57d86f12566352546d0003ca&embed=True&l=false">
                    </iframe>
                 <hr width="90%"/>
                 <h5>
            Copyright © 2014-16 escWorks.NET<sup>®</sup> All Rights Reserved
