...
<asp:Content ID="Content1" ContentPlaceHolderID="mainBody" runat="Server">
    ...
    <table style="width: 100%; border-collapse: collapse;" runat="server" id="contentsTable"
        ...
        <tr>
            ...
            <td>
                ...
                <h3><b>Audience</b><br /></h3>
                <asp:Label ID="lblAudience" runat="server" CssClass="mainBodySmall"></asp:Label>
            </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;" class="mainBody" id="contentsTable1" runat="server">
        ...
        <tr>
            ...
            <td colspan="2"><asp:PlaceHolder runat="server" ID="pLocationPlaceHolder" /></td>
        </tr>
    </table>
    <br />
    <br />
