<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="groupregistration.aspx.cs" Inherits="catalog_groupregistration"
            ...
            <tr>
                <td class="mainBody">
                    <telerik:RadListBox ID="listBoxAvailableUsers" Width="440px" Height="250px" Style="text-align: left;"
                        ...
                        <ButtonSettings AreaWidth="110px" RenderButtonText="True" HorizontalAlign="Right"/>
                        <Localization ToLeft="Remove" ToRight="Add" AllToRight="Add All" AllToLeft="Remove All"/>
                    </telerik:RadListBox>
                </td>
                <td class="mainBody">
