...
runat="server"></asp:Label></strong></td>
            ...
            <tr>
                <td colspan="3" valign="top">
                    <strong><asp:Label ID="SaluatationLabel"
text="Salutation"
...
runat="server"></asp:Label></strong></td>
            ...
            <tr>
                <td style="width: 158px" valign="top">
                    <strong><label for=<%=txtHomePhone.ClientID%>>* Cell Phone:</label></strong></td>
                <td colspan="1" valign="top">
            ...
            <tr>
                <td style="width: 158px; height: 45px" valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtHomePhone"
                        CssClass="error" ErrorMessage="Cell Phone is required"></asp:RequiredFieldValidator></td>
                <td colspan="1" style="height: 45px" valign="top">
...
runat="server"></asp:Label>: </strong><i>(Select Region 19 if you do not know your region)</i></td>
            </tr>
            <tr>
                <td colspan="3" valign="top">
...
runat="server"></asp:Label>: </strong>(<i>Select Other if you do not know your district</i>)</td>
            </tr>
            <tr>
                <td colspan="3" valign="top">
                    <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="formInput" aria-required="true"  /><br />
                    <br />
             ...
             <tr>
                <td colspan="3" valign="top">
                    <asp:DropDownList ID="ddlPosition" runat="server" CssClass="formInput">
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlPosition"
                        CssClass="error" ErrorMessage="Position is a required field"></asp:RequiredFieldValidator>
...
runat="server"></asp:Label></strong></td>
                <td colspan="1" valign="top">
                    <strong><asp:Label ID="PasswordConfirmLabel"
