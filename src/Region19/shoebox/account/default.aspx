...
runat="server"></asp:Label></strong></td>
            ...
            <tr>
                <td style="width: 158px; height: 45px" valign="top">
                    ...
                    <asp:TextBox ID="txtHomePhone" Text="Cell Phone" runat="server" CssClass="formInput" /><br />
...
runat="server"></asp:Label>
                        ...
                        (<i>Select Region 19 ESC if you do not know your region</i>):</td>
            </tr>
            <tr>
                <td colspan="3" valign="top">
...
runat="server"></asp:Label></strong>
                        (<i>Select Other Organizations if you do not know your District</i>):</td>
            </tr>
            <tr>
                <td colspan="3" valign="top">
...
runat="server"></asp:Label></strong>
                        (<i>Select Other Organizations if you do not know your Campus</i>):</td>
            </tr>
            <tr>
                <td colspan="3" valign="top">
...
runat="server"></asp:Label></strong></td>
           ...
           <%-- <tr>
                <td  colspan="3" valign="top">
                   <strong><asp:Label ID="RequiredAccomsLabel"
