...
public partial class Search : System.Web.UI.UserControl
{
    ...
    {
        if (!chkFF.Checked && !chkVideo.Checked && !chkTETN.Checked)
        {
            lbError.Text = "You must select either Face-to-Face or Online or TETN.";
    ...
    private void LoadData()
    {
        ...
        grdSearch.DataSource = SearchInMemory(sessionInfoList, chkFF.Checked, chkVideo.Checked, chkTETN.Checked, chkFree.Checked, chkWeekend.Checked, keywords );
        grdSearch.DataBind();
    }
    ...
    protected List<SessionInfo> SearchInMemory(List<SessionInfo> sessionInfoList, bool faceToFace, bool online, bool tetn, bool free, bool weekend, string Keywords)
    {
        ...
        foreach (SessionInfo sessionInfo in sessionInfoList)
        {
            ...
            OKtoAdd &= (faceToFace && (sessionInfo.IsFaceToFace || sessionInfo.IsConference || sessionInfo.IsMultiVenue))
                    || (online && (sessionInfo.IsOnline || sessionInfo.IsMultiVenueOnline)) || (tetn && (sessionInfo.IsTETN));
