                ...
                <tr>
                    <td>
                        ...
                        <asp:CheckBox ID="chkVideo" runat="server" Text="Online" Checked="true" Font-Size="X-Small"
                            Width="15%" />
                        <asp:CheckBox ID="chkTETN" runat="server" Text="TETN" Checked="true" Font-Size="X-Small"
                            Width="15%" />
                        <asp:CheckBox ID="chkFree" runat="server" Text="Free" Font-Size="X-Small" Width="15%" />
