...
namespace escWeb.tx_r19.ObjectModel
{
    ...
    {
        private bool _ondemandAllowReview = false;

        public bool OndemandAllowReview { get { return _ondemandAllowReview; } }
      ...
      public override DateTime CancellationEndDate
        {
            get
            {
                switch (this.StartDate.DayOfWeek)
                {
                    ...
                    case DayOfWeek.Saturday:
                        return this.StartDate.AddDays(-5);
