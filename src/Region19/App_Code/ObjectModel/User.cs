...
namespace escWeb.tx_r19.ObjectModel
{
    ...
    public class User : region4.ObjectModel.User
    {
        ...
        private int _specialNeeds_id;
        public int SpecialNeeds_Id
        {
            get { return _specialNeeds_id;}
            set { _specialNeeds_id = value; }
        }
        ...
        protected override void LoadCustomerInfo(System.Data.SqlClient.SqlCommand cmd)
        {
            ...
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
                if (reader.Read())
                {
                    ...
                    _specialNeeds_id = reader["specialNeeds_Id"].ToString() == "" ? 0 : Convert.ToInt32(reader["specialNeeds_Id"].ToString());
        ...
        protected override void SaveCustomerInfo(System.Data.SqlClient.SqlCommand cmd)
        {
            ...
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@sid", this.Sid);
            cmd.Parameters.AddWithValue("@specialNeedsId", SpecialNeeds_Id);
