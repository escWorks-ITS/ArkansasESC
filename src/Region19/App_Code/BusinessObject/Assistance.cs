...
namespace demo.BusinessObect.Accountability
{
    [Serializable()]
    public class Assistance : BusinessBase<Assistance>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            //ValidationRules.AddRule(PointRule, Focus_IdProperty);
        ...
        {
            if (((Assistance)target).Contact_Id == 0 && !((Assistance)target).Activity_Name.ToLower().Contains("leave"))
            {
        ...
        private static bool ActivityRule(object target, Csla.Validation.RuleArgs e)
        {
            ...
            {
                e.Description = "The function field is required.";
                return false;
            }
            else
                return true;
        ...
        private static bool BudgetCodeRule(object target, Csla.Validation.RuleArgs e)
        {
            ...
            if (((Assistance)target).Budget_Id == 0 && ((Assistance)target).Activity_Name.ToLower() != "leave")
            {
                e.Description = "The budget code  is required.";
                return false;
            }

            if (!bi.Active && ((Assistance)target).Activity_Name.ToLower() != "leave")
            {
        ...
        {
            if (((Assistance)target).LocationAudiences.Count == 0 && !((Assistance)target).Activity_Name.ToLower().Contains("leave"))
            {
        ...
        private static bool PointRule(object target, Csla.Validation.RuleArgs e)
        {
            ...
            if (((Assistance)target).Focus_Id == 0 && !((Assistance)target).Activity_Name.ToLower().Contains("leave"))
            {
