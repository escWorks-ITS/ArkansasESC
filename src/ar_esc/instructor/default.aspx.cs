...
public partial class instructor_default : region4.escWeb.BasePages.Instructor.default_aspx
{
    ...
    public override HtmlTableRow ReturnSessionRow(region4.ObjectModel.SessionInfo sessionInfo, bool altRow)
    {
        ...
        System.Web.UI.LiteralControl l = new System.Web.UI.LiteralControl(String.Format("<a href=\"email.aspx?session_id={0}\"><img src=\"{1}lib/img/email.gif\" alt=\"Email \" style=\"border: 0px;\" /></a>", sessionInfo.SessionID, this.PathToRoot));
        ...
        escWeb.ar_esc.ObjectModel.SessionInfo s = (escWeb.ar_esc.ObjectModel.SessionInfo)sessionInfo;
        l = new System.Web.UI.LiteralControl(String.Format("<a href=\"waitinglist.aspx?sessionid={0}\"><img src=\"{1}lib/img/waitinglist.gif\" alt=\"waiting list \" style=\"border: 0px;\" /></a>", sessionInfo.SessionID, this.PathToRoot));
        row.Cells[0].Controls.Add(l); //WaitingList icon
