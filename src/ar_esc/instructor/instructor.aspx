...
<html lang="en-us" xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
         ...
         <MasterTableView Width="100%" DataKeyNames="ID" AllowMultiColumnSorting="false" Name="Attendance" Caption="Attendance" Summary="Table holding Attendee records.">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="UserSiteRoomDisplay" UniqueName="UserSiteRoomDisplay"
                    ...
                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                    Groupable="false" Reorderable="false" Visible="true" FilterControlToolTip="Type the Siteroom">
                </telerik:GridBoundColumn>
