...
public partial class _Default : region4.escWeb.BasePages.default_aspx
{
    ...
    { 
        ...
        //{
        //    var u = HttpContext.Current.Request.ServerVariables["HTTP_USER_AGENT"].ToString();
        //    if (u.Contains("13.0.3"))
        //    {
        //        this.HeaderWidth = "305px";
        //    }
        //    else
        //    {
        //        this.HeaderWidth = "343px";
        //    }
        //}
        ...
        using (SqlConnection conn = region4.Common.DataConnection.DbConnection)
        {
            ...
            foreach (FileNameURL fileNameURL in listFiles)
            {
                ...
                if (IsMobileBrowser())
                {
                    ...
                    if (!u.Contains("13.0.3"))
                    {
                        hyperLink.ImageWidth = new Unit(225);
                        hyperLink.ImageHeight = new Unit(160);
                        //this.HeaderWidth = "305px";
                    }
                    else
                    {
                        hyperLink.ImageWidth = new Unit(275);
                        hyperLink.ImageHeight = new Unit(200);
                        //this.HeaderWidth = "343px";
                    }
                }
                else
                {
                    hyperLink.ImageWidth = new Unit(435);
                    hyperLink.ImageHeight = new Unit(294);
                }
