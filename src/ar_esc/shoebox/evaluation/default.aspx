<%@ Page Language="c#" Inherits="tx_r16.Shoebox.Evaluation.Pages.DefaultPage" EnableViewState="False" EnableViewStateMac="False" CodeFile="Default.aspx.cs" %>
...
<body onload="Page_OnInit();" style="margin: 0px;">
    <table cellspacing="0" cellpadding="0" width="100%" height="100%" border="0">
        ...
        <tr>
            <td bgcolor="#ffffff">&nbsp;<img src="/global/img/ico/32/Evaluation.gif" width="32" height="32" alt="" border="0" align="absMiddle"></td>
            <td bgcolor="#ffffff"><span style="font-weight: bold; font-size: 12pt; color: #191970">
        ...
        <tr>
            <td bgcolor="#ffffff">&nbsp;<img src="/global/img/ico/32/secure.gif" width="32" height="32" alt="" border="0" align="absMiddle"></td>
            <td bgcolor="#ffffff"><span style="font-weight: bold; font-size: 8pt; color: #191970">escWorks<small><sup>&reg;</sup></small> .NET Evaluation Form &copy; 2016 </span>
                <br>
            </td>
        </tr>
        <tr>
